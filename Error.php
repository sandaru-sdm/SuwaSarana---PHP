                        ...
                        <div class="card p-3  py-4 mt-5 ">
                            ...
                            <div class="row g-3 mt-2 d-flex justify-content-center align-items-center mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <h1 class="text-center">Your Donation is Failed!</h1>
                                    <br>
                                    <a class="btn btn-secondary col-3 justify-content-center align-content-center d-flex container-fluid text-center"  href="index.php">Home Page</a>
